"""
Real-time inference module for ASL Alphabet Recognition
"""
import numpy as np
import cv2
...
class ASLPredictor:
    ...
    def predict_from_webcam_frame(self, frame):
        """
        Predict from webcam frame with ROI extraction
        
        Args:
            frame: Webcam frame (numpy array)
            
        Returns:
            Prediction results and processed frame
        """
        ...
        # Convert ROI to RGB for prediction
        ...
        # Add instructions
        cv2.putText(display_frame, "Position hand in green box", 
                   (roi_x, roi_y - 10),

...
class ASLEvaluator:
    ...
    def _plot_confusion_matrix(self, y_true, y_pred, class_indices):
        ...
        plt.title('Confusion Matrix - ASL Alphabet Recognition', fontsize=16, fontweight='bold', pad=20)
        ...
        plt.title('Normalized Confusion Matrix - ASL Alphabet Recognition', fontsize=16, fontweight='bold', pad=20)
        plt.xlabel('Predicted Label', fontsize=12, fontweight='bold')
        plt.ylabel('True Label', fontsize=12, fontweight='bold')
        plt.tight_layout()
